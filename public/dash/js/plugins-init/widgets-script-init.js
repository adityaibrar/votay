				...
				new Chart(chart_widget_11, {
					...
					data: {
						...
						datasets: [{
							...
							borderColor: '#2AADB9',
							pointBackgroundColor: '#2AADB9',
							pointBorderColor: '#2AADB9',
							pointHoverBackgroundColor: '#2AADB9',
							pointHoverBorderColor: '#2AADB9',
			...
			if (jQuery('#chart_widget_17').length > 0) {
				...
				new Chart(chart_widget_17, {
					...
					data: {
						...
						datasets: [{
							label: "Sales Stats",
							backgroundColor: ['#1569B3'],
							borderColor: '#1569B3',
							pointBackgroundColor: '#1569B3',
							pointBorderColor: '#1569B3',
							borderWidth: 4,
							borderRadius: 10,
